...
Reproducible Consistent Cut result is Tier 2, paper-argued, with a first measured
exercise (U-3, CV8) covering the exercised workloads and schedules only and a
universal proof pending; its validation gap has narrowed now that the SMP
foundation exists, but the multi-core consistent capture is not yet demonstrated. The deduplication impossibility bound, the content-addressed
...
The result in this section is paper-argued theory. The SMP foundation of the earlier
...
not validated on it. The DRCC result is paper-argued theory with a first measured
exercise (U-3, CV8) covering the exercised workloads and schedules only and a
universal proof pending; its validation gap has narrowed now that the foundation
exists, but \carmix{} does not yet exhibit the multi-core cut (Tier 2).
